    ...
    <div class="content-body mt-30 pt-30">
        ...
        <div class="w-content bg-white">
            ...
            <div class="row">
                <div class="col col-xs-12 col-md-12 col-lg-12 text-center">
                    <h1>Gladys Marion Dunton</h1>
                    <h6 class="text-uppercase font15 h6-style">october 21, 1923 - august 4, 2017</h6>
                    <p class="text-uppercase mb-30">"the plant whisperer"</p>
                    ...
                    <p class="text-left capitalLetter mt-30">
        ...
        <div class="">
            <div class="sub-nav-main">
                <ul class="text-uppercase text-center nav font12">
                    <li class=" first ">
                        <a href="#">
                            <div class="container-icon">
        ...
        <section class="container-fluid mt-30 pt-40 bg-gg pb-40">
            <h2 class="text-center mb-30">Services</h2>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <div class="col col-xs-5 col-sm-5 col-md-4 col-lg-3 text-center col-date ">
                            <div class="row row-date">
                                <div class="content-d">
                                    <h2 class="h2-style-xs">23</h2>
                                    <p class="text-uppercase ">december</p>
                ...
                <div class="row">
                    <div class="col col-xs-12 col-md-12 col-lg-12">
                        <div class="mt-30 mb-30 pt-40 pb-40">
                            ...
                            <h2 class="text-center h2-style-sm">Gladys Marion Dunton</h2>
                        </div>
        ...
        <section class="container-fluid bg-gray mb-30">
            <div class="bio">
                <h2 class="text-center mb-30">Biography</h2>
