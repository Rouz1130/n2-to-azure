...
<div class="component component-no-child-margin panel-group" id="<%=UniqueDomId("accordion")%>" role="tablist" aria-multiselectable="true" data-event-name="accordion-product-details">
	<div class="panel active">
		<div class="panel-heading" role="tab" id="<%=UniqueDomId("hdr1")%>">
			...
			<a data-toggle="collapse" data-parent="#<%=UniqueDomId("accordion")%>" href="#<%=UniqueDomId("pnl1")%>" aria-expanded="true" aria-controls="<%=UniqueDomId("pnl1")%>" class="icon"><i></i></a>
		</div>
	...
	<div class="panel" data-event-data="Custom event data overrides panel heading">
		<div class="panel-heading" role="tab" id="<%=UniqueDomId("hdr2")%>">
			...
			<a class="collapsed icon" data-toggle="collapse" data-parent="#<%=UniqueDomId("accordion")%>" href="#<%=UniqueDomId("pnl2")%>" aria-expanded="false" aria-controls="<%=UniqueDomId("pnl2")%>"><i></i></a>
		</div>
	...
	<div class="panel" data-event-name="accordion-panel-customer-reviews">
		<div class="panel-heading" role="tab" id="<%=UniqueDomId("hdr3")%>">
			...
			<a class="collapsed icon" data-toggle="collapse" data-parent="#<%=UniqueDomId("accordion")%>" href="#<%=UniqueDomId("pnl3")%>" aria-expanded="false" aria-controls="<%=UniqueDomId("pnl3")%>"><i></i></a>
		</div>
